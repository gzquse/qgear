...
def get_parser():
 ...
 # IO paths
    parser.add_argument("--basePath",default='/global/cfs/cdirs/mpccc/balewski/quantDataVault2024/dataCudaQ_june28_good',help="head path for set of experiments, or 'env'")
