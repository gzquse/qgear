...
def get_parser(backName="ibmq_qasm_simulator",provName="local sim",doMathOp=False):
    ...
    # .... job running
    parser.add_argument('-n','--numShotPerAddr',type=int,default=4000, help="shots per address of QCrank, or as-is if negative")
...
#...!...!....................
def qcrank_and_EscherHands(md, barrier=True):
    # can store mutiple Ehands blocks in parallel
    pmd=md['payload']
    nq_addr=pmd['nq_addr']
...
if __name__ == "__main__":
    ...
    # ------  circuit generation -------
    qcrankObj=qcrank_and_EscherHands( expMD)
