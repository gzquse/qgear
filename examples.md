...
```
    ...
    qiskit_to_gateList: nGate 22
    saving data as hdf5: out/toy_example.gate_list.h5
    h5-write : circ_type (1, 2) int32
    h5-write : gate_type (1, 22, 3) int32
    h5-write : gate_param (1, 22) float32
    h5-write : meta.JSON as string (1,) object
    closed  hdf5: out/toy_example.gate_list.h5  size=0.01 MB, elaT=0.0 sec
    === CUDA-Q Results ===
    Execution time: 2.5256 s
    Counts: {'000000000000000000': 4300, '000000000000000100': 707, '000000000000000011': 4277, '000000000000000111': 716}

    === Qiskit Aer Results ===
    Execution time: 1.1374 s
    Counts: {'000000000000000100': 735, '000000000000000111': 713, '000000000000000011': 4241, '000000000000000000': 4311}
    CUDA-Q is slower by 2.22x
...
```
    ...
    /tmp/ipykernel_106336/378558003.py:19: DeprecationWarning: The class ``qiskit.circuit.library.basis_change.qft.QFT`` is deprecated as of Qiskit 2.1. It will be removed in Qiskit 3.0. ('Use qiskit.circuit.library.QFTGate or qiskit.synthesis.qft.synth_qft_full instead, for access to all previous arguments.',)
      qc = QFT(num_qubits=n_qubits, do_swaps=False).decompose()
    ...
    === QFT 3 qubits ===
    CUDA-Q (nvidia): 0.0034 s
    AerSimulator: 0.0030 s
    CUDA-Q slower by 1.14x
    ...
    === QFT 6 qubits ===
    CUDA-Q (nvidia): 0.0025 s
    AerSimulator: 0.0039 s
    Speedup (Aer / CUDA-Q): 1.55x
    ...
    === QFT 20 qubits ===
    CUDA-Q (nvidia): 0.0225 s
    AerSimulator: 0.2576 s
    Speedup (Aer / CUDA-Q): 11.45x

![](examples_files/figure-commonmark/cell-3-output-3.png)
