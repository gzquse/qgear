...
class _DecoderQCRANK(ABC):
    ...
    @staticmethod
    def angles_to_idata(angles, max_val=256): # rounds to integer
        return rescale_angles_to_idata(angles, max_val=max_val)
    @staticmethod
    def angles_to_fdata(angles, max_val=256): # returns floats
